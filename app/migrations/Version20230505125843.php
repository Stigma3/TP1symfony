 ...
 */
final class Version20230505125843 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication ADD user_id INT NOT NULL, DROP name_pub');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication ADD name_pub VARCHAR(100) NOT NULL, DROP user_id');
    }
}
